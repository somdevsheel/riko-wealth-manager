# Claude Code Prompt — Riko Frontend + AI Layer

> Paste this into Claude Code from the root of the `riko/` folder (the one
...
I'm building **Riko**, an AI avatar wealth advisor for **IDBI Innovate 2026
